...
get_filename_component(_filename "/home/santi/wsfin/src/tum_simulator/cvg_sim_gazebo_plugins/srv/SetBias.srv" NAME_WE)
add_custom_target(_cvg_sim_gazebo_plugins_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "cvg_sim_gazebo_plugins" "/home/santi/wsfin/src/tum_simulator/cvg_sim_gazebo_plugins/srv/SetBias.srv" "geometry_msgs/Vector3"
)
...
_generate_srv_cpp(cvg_sim_gazebo_plugins
  "/home/santi/wsfin/src/tum_simulator/cvg_sim_gazebo_plugins/srv/SetBias.srv"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/cvg_sim_gazebo_plugins)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/cvg_sim_gazebo_plugins\")")
  # install generated code
  install(
